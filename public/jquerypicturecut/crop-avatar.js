(function (factory) {
  ...
  function CropAvatar($element) {
    ...
    this.$avatarDataInput = this.$avatarView.find("input");
    this.$avatarModal = this.$container.find("#my-avatar-modal");
  ...
  CropAvatar.prototype = {
    ...
    cropDone: function () {
      ...
      this.$avatarDataInput.val(this.url);
      this.stopCropper();
      this.$avatarModal.find('.uk-close').trigger("click");
    },
