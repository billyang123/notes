<div class="uk-width-medium-3-4">
	...
	<article class="uk-article _index-article uk-panel-box">
        ...
        <p><a href="<?=$assets?>/index.php/comment?noteId=<?=$item['id'] ?>" data-remote-once="true" class="uk-button" data-remote="true" data-done="$('.js-comment-<?=$item['id'] ?>').html(res).parent().show()">comment(2)</a></p>
