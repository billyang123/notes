<body>
    <?php if ($id):?>
    <h2>demo 编辑</h2>
    <form class="form-horizontal" action="<?=$assets ?>/index.php/demo/up/<?=$id ?>" method="post" data-remote="true">
    ...
    <?php else: ?>
    <h2>demo 新增</h2>
    <form class="form-horizontal" action="<?=$assets ?>/index.php/demo/up" method="post" data-remote="true">
      <div class="form-group">
        <label class="col-sm-2 control-label">demo描述</label>
        <div class="col-sm-10">
