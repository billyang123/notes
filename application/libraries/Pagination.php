...
class CI_Pagination {
	...
	var $first_link			= '第一页';
	var $next_link			= '<i class="uk-icon-angle-double-right"></i>';
	var $prev_link			= '<i class="uk-icon-angle-double-left"></i>';
	var $last_link			= '最后一页';
	var $uri_segment		= 2;
	...
	var $first_url			= '2'; // Alternative URL for the First Page.
	var $cur_tag_open		= '<li class="uk-active"><span>';
